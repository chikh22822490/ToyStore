...
{
    public partial class DeleteToy : Form
    {
        public DeleteToy()
        {
            InitializeComponent();
        ...
        private void DeleteToy_Load(object sender, EventArgs e)
        {
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand();
                        cmd.CommandText = "delete from Toys where Id= " + id_toy;
                        cmd.Connection = con;
                        cmd.ExecuteNonQuery();
